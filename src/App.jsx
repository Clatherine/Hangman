  ...
  return (
    <section id="whole">
      <Game
        ...
        inAction={inAction} setInAction={setInAction}
      /> {
        inAction?    <Buttons
        hangmanState={hangmanState}
        setHangmanState={setHangmanState}
        wordState={wordState}
        word={word}
        setWordState={setWordState}
        setInAction={setInAction} inAction={inAction}
      /> : null
      }
  ...
  return (
    <section id="main">
      <div className="flex-item" id="buttonDiv">
        ...
        <WordToComplete wordState={wordState} />
      </div>
...
function Game({ handleDifficultyChange, inAction, setInAction }) {
  const handleClick = (event) => {
  ...
  return (
    <section id="header">
      <div id="title">
        ...
        <p id="text">
          Choose a difficulty level, then guess the word before the man gets
          hanged!
        </p>
      </div>
      {inAction ? null : (
        <div id="difficulty">
          ...
          <div id="buttons">
            <button onClick={handleClick} className="game">
              Easy
            </button>
            <button onClick={handleClick} className="game">
              Fun
